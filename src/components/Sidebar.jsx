...
import { LayoutDashboard, FileText, Users, LogOut, Briefcase,Wallet, Landmark, BookOpen, FileBarChart2, Building2, Factory, Calendar, User, Settings } from 'lucide-react';
...
const Sidebar = () => {
    ...
    return (
        <div className="w-64 bg-white border-r border-gray-200 h-screen flex flex-col fixed left-0 top-0 shadow-sm z-10">
            ...
            <nav className="flex-1 p-4 space-y-2 mt-4">
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            <Icon className={clsx("h-5 w-5 transition-colors", isActive ? "text-indigo-600" : "text-gray-400 group-hover:text-gray-600")} />
                            {item.label}
                        </Link>
                    );
                })}
